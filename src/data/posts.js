export const getExamplePosts = () => ([
    ...
    },
    {
        ...
        message: 'Yeah, US immigration is completely backwards: trivial to enter illegally and nightmarishly difficult to enter legally!'
    },
])